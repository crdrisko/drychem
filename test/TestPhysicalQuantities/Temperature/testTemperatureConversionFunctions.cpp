...
#include "../../../src/include/internal/PhysicalQuantities/TemperatureQuantities/temperature.hpp"
...
long double ConversionAssert::doConversion() const
{
    ...
    Temperature convertedTemperature = Conversions::convertTemperature(temperature, initialUnits, finalUnits);
