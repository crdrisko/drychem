...
//
// Name: testSI_UnitConversionFunctions.cpp - Version 1.0.0
// Author: cdrisko
// Date: 01/31/2020-16:04:48
// Description: Provides 100% unit test coverage over all SI unit prefix conversion functions

#include "../testAssertions.hpp"
#include "../../../src/include/internal/PhysicalQuantities/conversions.hpp"
...
long double ConversionAssert::doConversion() const
{
    ...
    return (dimensionlessQuantity.convertQuantity(Conversions::getSIPrexixConversionFactor(initialUnits,
        finalUnits))).getMagnitude();
}

TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_yotta)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_zetta)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_exa)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_peta)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_tera)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_giga)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_mega)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_kilo)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_hecto)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_deka)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_base)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_deci)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_centi)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_milli)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_micro)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_nano)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_pico)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_femto)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_atto)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_zepto)
{
...
TEST(testSI_UnitConversionFunctions, conversionsOfLengthFrom_yocto)
{
