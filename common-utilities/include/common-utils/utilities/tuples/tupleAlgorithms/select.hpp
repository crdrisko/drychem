...
#ifndef DRYCHEM_COMMON_UTILITIES_INCLUDE_COMMON_UTILS_UTILITIES_TUPLES_TUPLEALGORITHMS_SELECT_HPP
#define DRYCHEM_COMMON_UTILITIES_INCLUDE_COMMON_UTILS_UTILITIES_TUPLES_TUPLEALGORITHMS_SELECT_HPP
